...
function createStudent({likesJavaScript = true, likesES2015 = true} = {}){
  let base = 'The student likes'
  if (likesJavaScript && likesES2015) return base + ' JavaScript and ES2015!';    
  else if (likesES2015) return base + ' ES2015!';
  else if (likesJavaScript) return base + ' JavaScript!';    
